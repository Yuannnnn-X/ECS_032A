...
happiness = {} # make the happiness dictionary out of the function
...
def read_gdp_data(happy_dict): # the function is used to read the tsv file
    ...
    for line in outfile: # print the line in the file without some signs
        line = line.strip() # strip the space
        line = line.replace(",","") # omit the commas in numbers
        line = line.replace("$","") # omit the dollar sign
        line = line.replace("\t",",") # change the tabs with commas
